      ...
      <div className="flex items-center justify-between h-[72px] gap-6">
        ...
        >
          ...
          <div className="flex flex-col leading-[1.1] w-fit">
            ...
            <span className="text-[#8fa8c8] font-display font-semibold text-[8px] xs:text-[9px] sm:text-[11px] tracking-[3px] sm:tracking-[4px] uppercase mt-[3px] block">ENGINEERING</span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <a
            ...
            className="hidden md:block relative group bg-brand-red text-white px-6 py-2.5 text-[12px] font-bold tracking-[1.5px] uppercase no-underline transition-all hover:bg-brand-red-hover font-display whitespace-nowrap shadow-[0_8px_30px_rgba(220,38,38,0.45)] hover:shadow-[0_8px_30px_rgba(220,38,38,0.7)]"
          >
            {/* Pulse Effect - Desktop Only */}
            <span className="absolute inset-0 bg-brand-red animate-ping opacity-30 group-hover:opacity-50"></span>
            <span className="relative z-10">{t('Get a Quote', 'Omba Bei')}</span>
          </a>
