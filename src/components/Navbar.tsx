                          ...
                          {/* CTA - Desktop Only */}
                                  <a
                                    ...
                                    {/* Pulse Effect - Desktop Only */}
                                              <span className="absolute inset-0 bg-brand-red animate-ping opacity-30 group-hover:opacity-50"></span>span>
                                              <span className="relative z-10">{t('Get a Quote', 'Omba Bei')}</span>span>
                                  </a>a>
